...
public class CustomTabLayout extends HorizontalScrollView {
    ...
    private int textHorizontalPadding = 12;
    private int textVerticalPadding = 12;
...
//        addView(mTabStrip, LayoutParams.MATCH_PARENT, LayoutParams.WRAP_CONTENT);
    ...
    public void setTabStripWidth(int width) {
        mTabStrip.setWidth(dp2px(width));
    }
    ...
    /**
     * set text padding for left&right
     *
     * @param horizontalPadding
     */
    public void setTextHorizontalPadding(int horizontalPadding) {
        this.textHorizontalPadding = dp2px(horizontalPadding);
    }

    /**
     * set text padding for top&bottom
     *
     * @param verticalPadding
     */
    public void setTextVerticalPadding(int verticalPadding) {
        this.textVerticalPadding = dp2px(verticalPadding);
    ...
    protected TextView createDefaultTabView(Context context) {
        ...
        textView.setPadding(textHorizontalPadding, textVerticalPadding, textHorizontalPadding, textVerticalPadding);
